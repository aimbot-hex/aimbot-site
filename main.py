...
def web_panel():
    ...
    <head>
        ...
        <title>🎮 AIMBOT HEX - Gaming Emote Panel</title>
...
.discord-stat .stat-icon {
        ...
        <div class="dashboard">
            ...
            <div class="header">
                <div class="logo">
                    ...
                    <div class="logo-text">AIMBOT HEX</div>
                </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-label">إجمالي الرموز التعبيرية</div>
    </div>

    <!-- كرت Discord (كرت مستقل تمامًا) -->
    <a href="https://discord.gg/fFsWKRAqDu"
       target="_blank"
       class="stat-card discord-stat">
    ...
    <div class="stat-card">
        ...
        <div class="stat-label">ملفات PNG محلية</div>
    </div>
    ...
    <div class="stat-card">
        <div class="stat-icon">🌐</div>
        <div class="stat-value">391</div>
        <div class="stat-label">نسخ احتياطية لـ CDN</div>
    </div>
            ...
            <div class="main-grid">
                ...
                <div class="left-column">
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            <div class="panel-icon">🚀</div>
                            <div class="panel-title">إرسال رمز تعبيري</div>
                        </div>
                        
                        <div class="input-group">
                            <label class="input-label">
                                <i class="fas fa-users"></i> رمز الفريق
                            </label>
                        ...
                        <div class="input-group">
                            <label class="input-label">
                                <i class="fas fa-user"></i> معرف اللاعب
                            </label>
                        ...
                        <div class="input-group">
                            <label class="input-label">
                                <i class="fas fa-icons"></i> معرف الرمز التعبيري (اختياري)
                            </label>
                        ...
                        <button class="btn" onclick="sendManualEmote()">
                            <i class="fas fa-paper-plane"></i> أرسل الرمز التعبيري الآن
                        </button>
                ...
                <div class="right-column">
                    <div class="emote-grid-container">
                        <div class="panel-header">
                            <div class="panel-icon">🎭</div>
                            <div class="panel-title">مكتبة الرموز التعبيرية <span style="font-size: 0.9rem; color: var(--gray); margin-left: 10px;">(433 emotes loaded)</span></div>
                        </div>
        ...
        <script>
            ...
            function setMode(mode) {
                ...
                if (mode === 'normal') {
                    ...
                    showToast('Mode Changed', 'الوضع العادي activated', 'info');
                } else {
            ...
            function updateEmoteCardsMode() {
                const cards = document.querySelectorAll(".stat-card:not(.discord-stat)");
                cards.forEach(card => {
            ...
            async function loadEmotes() {
                try {
                    ...
                    // Update stats (safe)
const totalEmotesEl = document.getElementById('totalEmotes');
if (totalEmotesEl) totalEmotesEl.textContent = allEmotes.length;

const localEmotesEl = document.getElementById('localEmotes');
if (localEmotesEl) localEmotesEl.textContent = localEmotesCount;

const cdnEmotesEl = document.getElementById('cdnEmotes');
if (cdnEmotesEl) cdnEmotesEl.textContent = cdnEmotesCount;
...
🌐 Web Panel: http://0.0.0.0:5000/
📡 API: http://0.0.0.0:5000/emote?uid=...&emote_id=...&teamcode=...
